    ...
    <div className='flex bg-primary rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'>
        ...
        <div className='flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5'>
            <div className='text-xl sm:text-2xl md:text-3xl  font-semibold text-white'>
                <p className='lg:text-4xl'>Book Appointment</p>
                <p className='mt-4 lg:text-3xl'>With 100+ Trusted Doctors</p>
            </div>
        ...
        <div className='hidden md:block md:w-1/2 lg:w-[350px] relative'>
            <img className='w-full absolute bottom-11 right-0 max-w-md' src={assets.appointment_img} alt="" />
        </div>
